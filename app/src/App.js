  ...
  return (
    <Router>
      <Switch>
        ...
        <Route path='/test0' exact component={() => <TestView images={getImages(0)} time={baseTime} testPhase={0} testEntry={entry} />} />
        <Route path='/test1' exact component={() => <TestView images={getImages(1)} time={baseTime*2} testPhase={1} testEntry={entry} />} />
        <Route path='/test2' exact component={() => <DrawingView images={getImages(2)} time={baseTime*0.2} testPhase={2} testEntry={entry} />} />
